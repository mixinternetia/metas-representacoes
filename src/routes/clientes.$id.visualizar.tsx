...
export const Route = createFileRoute("/clientes/$id/visualizar")({
  head: () => ({ meta: [{ title: "Visualizar Cliente — Metas Representações" }] }),
...
function VisualizarClientePage() {
  ...
  return <ClienteForm mode="visualizar" initial={cliente} />;
}
